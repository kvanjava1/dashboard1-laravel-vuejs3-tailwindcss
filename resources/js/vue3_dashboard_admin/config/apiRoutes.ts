  ...
  media: {
    index: (
      ...
      if (params?.gallery_id)
        searchParams.set("gallery_id", params.gallery_id.toString());
      ...
      if (params?.size_range) searchParams.set("size_range", params.size_range);
      return `/api/v1/media${searchParams.toString() ? "?" + searchParams.toString() : ""}`;
    },
    show: (id: string | number) => `/api/v1/media/${id}`,
    store: "/api/v1/media",
    update: (id: string | number) => `/api/v1/media/${id}`,
    destroy: (id: string | number) => `/api/v1/media/${id}`,
  },
