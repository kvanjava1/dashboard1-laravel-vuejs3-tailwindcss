<template>
    <div class="space-y-2">
        ...
        <div class="relative">
            ...
            <select v-if="type === 'select'" :id="inputId" :value="modelValue" :required="required" :class="[
            ...
            <input v-else-if="type === 'date'" :id="inputId" :value="modelValue" :type="type" :placeholder="placeholder"
            ...
            <input v-else-if="type === 'number'" :id="inputId" :value="modelValue" type="number"
            ...
            <input v-else :id="inputId" :value="modelValue" :type="type" :placeholder="placeholder" :required="required"
                :class="[
                    'w-full border border-border-light bg-slate-50 text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary transition-all',
                    leftIcon ? 'pl-10 pr-4' : 'px-4',
                    'py-2.5'
